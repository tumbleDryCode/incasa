                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="top-contact float-right">
								...
								<?php } ?>
								| </li>
								<li><i class="fas fa-user text-primary mr-1"></i><a href="register.php"> Registe-se</li>
								</ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><b>eu...</b><img class="nav-logo" src="images/logo/logo-small.png" alt="" style="max-height:100px"></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
										...
										<li class="nav-item"> <a class="nav-link" href="property.php">Propriadades</a> </li>
										...
										<li class="nav-item dropdown">
											...
											<ul class="dropdown-menu">
												...
												<li class="nav-item"> <a class="nav-link" href="feature.php">Suas Propriadedes</a> </li>
									...
									<a class="btn btn-primary d-none d-xl-block" href="submitproperty.php">Adicionar Propriadade</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
